...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      "z-50 overflow-hidden rounded-sm bg-[color:var(--color-surface-container-highest)] px-3 py-2 text-xs text-[color:var(--color-on-surface)] elev-floating ghost-border",
